...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSadminloginENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSadminloginENDCLASS_t qt_meta_stringdata_CLASSadminloginENDCLASS = {
    {
        QT_MOC_LITERAL(0, 10),  // "adminlogin"
        QT_MOC_LITERAL(11, 16),  // "handleAdminLogin"
        QT_MOC_LITERAL(28, 0)   // ""
    },
    "adminlogin",
    "handleAdminLogin",
...
void adminlogin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->handleAdminLogin(); break;
        default: ;
        }
    }
    (void)_a;
